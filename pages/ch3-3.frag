...
<section class="block" id="examples">
  ...
  <article class="ex-card">
    ...
    <div class="ex-body">
      ...
      <ol class="steps">
        ...
        <li><span class="step-t">หา eigenvector ของ \(\lambda = 5\)</span>
        ...
        <li><span class="step-t">หา eigenvector ของ \(\lambda = 0\)</span>
        \[ A - 0I_2 = A \;\Longrightarrow\; x_1 - x_2 = 0 \;\Longrightarrow\; \vec{v}_2 = \begin{bmatrix} 1\\ 1 \end{bmatrix} \]</li>
      ...
      <div class="verify"><span class="lbl">ตรวจคำตอบ:</span> \(A(1,-4)^T = (1 + 4,\; -4 - 16)^T = (5, -20)^T = 5(1, -4)^T\) ✓ และ \(A(1,1)^T = (0, 0)^T = 0\cdot(1,1)^T\) ✓</div>
    </div>
  </article>
  ...
  <article class="ex-card">
    ...
    <div class="ex-body">
      ...
      <div class="approach"><span class="lbl">แนวคิด</span> — eigenpair → ผลเฉลยทั่วไป → แทน \(t = 0\) → แก้หา \(C_1, C_2\) → แทนกลับ</div>
      <ol class="steps">
        <li><span class="step-t">หาค่าลักษณะเฉพาะ</span>
        \[ \det(A - \lambda I_2) = (1-\lambda)(3-\lambda) - 8 = \lambda^2 - 4\lambda - 5 = (\lambda - 5)(\lambda + 1) = 0 \;\Longrightarrow\; \lambda = 5, \; -1 \]</li>
        <li><span class="step-t">หา eigenvectors</span> \(\lambda = 5\): \(A - 5I_2 = \begin{bmatrix} -4 & 2\\ 4 & -2 \end{bmatrix} \Rightarrow 2x_1 = x_2 \Rightarrow \vec{v}_1 = (1, 2)^T\); &nbsp; \(\lambda = -1\): \(A + I_2 = \begin{bmatrix} 2 & 2\\ 4 & 4 \end{bmatrix} \Rightarrow x_1 = -x_2 \Rightarrow \vec{v}_2 = (1, -1)^T\)</li>
        <li><span class="step-t">ผลเฉลยทั่วไป</span>
        \[ \vec{x}(t) = C_1e^{5t}\begin{bmatrix} 1\\ 2 \end{bmatrix} + C_2e^{-t}\begin{bmatrix} 1\\ -1 \end{bmatrix} \]</li>
        <li><span class="step-t">แทน \(t = 0\) เทียบเงื่อนไขเริ่มต้น</span>
        ...
        <li><span class="step-t">แก้ระบบ</span> บวกสองสมการ: \(3C_1 = 3 \Rightarrow C_1 = 1\), \(C_2 = 1\)</li>
        <li><span class="step-t">ผลเฉลยเฉพาะ</span>
      ...
      <div class="verify"><span class="lbl">ตรวจคำตอบ:</span> \(t = 0\): \(x_1 = 2, x_2 = 1\) ✓ และเช็กสมการแรกที่ \(t = 0\): LHS \(x_1'(0) = 5 - 1 = 4\); RHS \(x_1(0) + 2x_2(0) = 2 + 2 = 4\) ✓</div>
    </div>
  </article>
  ...
  <article class="ex-card">
    ...
    <div class="ex-body">
      ...
      <div class="approach"><span class="lbl">แนวคิด</span> — ระบบนี้มี \(A\) ที่ diagonalizable ด้วย \(D = \operatorname{diag}(1, 2, 2)\), \(P = \begin{bmatrix} 3 & 2 & 2\\ -1 & 1 & 0\\ 3 & 0 & 1 \end{bmatrix}\) — เขียนผลเฉลยทั่วไปก่อน แล้วแก้หา \(C\) จากเงื่อนไขเริ่มต้น</div>
      <ol class="steps">
        <li><span class="step-t">รูปเมทริกซ์และ eigenpair</span>
        \[ A = \begin{bmatrix} 5 & -6 & -6\\ -1 & 4 & 2\\ 3 & -6 & -4 \end{bmatrix}, \qquad \lambda = 1, 2, 2 \]
        เมื่อแก้ \((A - \lambda I)\vec{x} = \vec{0}\) แต่ละค่าจะได้
        \[ \vec{v}_1 = \begin{bmatrix} 3\\ -1\\ 3 \end{bmatrix} \;(\lambda = 1), \qquad \vec{v}_2 = \begin{bmatrix} 2\\ 1\\ 0 \end{bmatrix}, \; \vec{v}_3 = \begin{bmatrix} 2\\ 0\\ 1 \end{bmatrix} \;(\lambda = 2 \text{ ซ้ำ แต่ได้ 2 เวกเตอร์อิสระ} \Rightarrow \text{diagonalizable}) \]</li>
        <li><span class="step-t">ผลเฉลยทั่วไป</span>
        ...
        <li><span class="step-t">แก้ระบบ (จากสมการที่ 2 และ 3 แทนในสมการที่ 1)</span> จากสมการที่ 2: \(C_2 = 2 + C_1\); จากสมการที่ 3: \(C_3 = -1 - 3C_1\); แทนในสมการที่ 1:
        \[ 3C_1 + 2(2 + C_1) + 2(-1 - 3C_1) = 4 \;\Longrightarrow\; 3C_1 + 4 + 2C_1 - 2 - 6C_1 = 4 \;\Longrightarrow\; -C_1 = 2 \;\Longrightarrow\; C_1 = -2 \]
        ดังนั้น \(C_2 = 0\), \(C_3 = -1 - 3(-2) = 5\)</li>
        <li><span class="step-t">ผลเฉลยเฉพาะ</span>
      ...
      <div class="verify"><span class="lbl">ตรวจคำตอบ:</span> \(t = 0\): \((x_1, x_2, x_3) = (-6+10, 2, -6+5) = (4, 2, -1)\) ✓ และเช็กสมการที่ 2 ที่ \(t = 0\): LHS \(x_2'(0) = 2\); RHS \(-x_1(0) + 4x_2(0) + 2x_3(0) = -4 + 8 - 2 = 2\) ✓</div>
    </div>
  </article>
</section>
...
<section class="block" id="practice">
  ...
  <article class="pr-card" data-pkey="p3-3-1">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> eigenpair → ผลเฉลยทั่วไป</p>
      <ol class="steps">
        ...
        <li><span class="step-t">ผลเฉลยทั่วไป</span>
        \[ \vec{x}(t) = C_1e^{5t}\begin{bmatrix} 1\\ 1 \end{bmatrix} + C_2e^{2t}\begin{bmatrix} 1\\ -2 \end{bmatrix} \qquad (C_1, C_2 \in \mathbb{R}) \]</li>
      </ol>
    </div></details>
  </article>
  ...
  <article class="pr-card" data-pkey="p3-3-2">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> ผลเฉลยทั่วไปก่อน แล้วใช้เงื่อนไขเริ่มต้น</p>
      <ol class="steps">
        <li><span class="step-t">ค่าลักษณะเฉพาะ</span>
        \[ \det(A - \lambda I_2) = (3-\lambda)(-2-\lambda) + 4 = \lambda^2 - \lambda - 2 = (\lambda - 2)(\lambda + 1) = 0 \;\Longrightarrow\; \lambda = 2, -1 \]</li>
        <li><span class="step-t">eigenvectors</span> \(\lambda = 2\): \(A - 2I_2 = \begin{bmatrix} 1 & -2\\ 2 & -4 \end{bmatrix} \Rightarrow x_1 = 2x_2 \Rightarrow \vec{v}_1 = (2, 1)^T\); &nbsp; \(\lambda = -1\): \(A + I_2 = \begin{bmatrix} 4 & -2\\ 2 & -1 \end{bmatrix} \Rightarrow 2x_1 = x_2 \Rightarrow \vec{v}_2 = (1, 2)^T\)</li>
        <li><span class="step-t">ผลเฉลยทั่วไปและแทน \(t = 0\)</span>
        ...
        <li><span class="step-t">แก้หา \(C\)</span> \(2C_1 + C_2 = 3\) และ \(C_1 + 2C_2 = 0 \Rightarrow C_2 = -\tfrac{C_1}{2}\) → \(2C_1 - \tfrac{C_1}{2} = 3 \Rightarrow C_1 = 2,\; C_2 = -1\)</li>
        <li><span class="step-t">ผลเฉลยเฉพาะ</span>
        ...
        <li><span class="step-t">ตรวจคำตอบ</span> \(t = 0\): \((4-1, 2-2) = (3, 0)\) ✓ และสมการที่ 1 ที่ \(t = 0\): LHS \(= 8 + 1 = 9\); RHS \(= 3(3) - 2(0) = 9\) ✓</li>
      </ol>
    </div></details>
  </article>
  ...
  <article class="pr-card" data-pkey="p3-3-3">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> สังเกตว่า \(x_1\) ไม่ปรากฏในสองสมการล่าง — ลดรูปสองสมการล่างก่อนได้</p>
      <ol class="steps">
        <li><span class="step-t">ค่าลักษณะเฉพาะ</span> บล็อกล่าง \(\begin{bmatrix} 1 & 3\\ 3 & 1 \end{bmatrix}\) มี \(\lambda = 4, -2\) และ \(x_1\) พาไปได้อีกค่าจาก char. poly รวมเป็น
        \[ \det(A - \lambda I_3) = (1 - \lambda)\big[(1-\lambda)^2 - 9\big] = (1-\lambda)(\lambda - 4)(\lambda + 2) = 0 \;\Longrightarrow\; \lambda = 1, 4, -2 \]</li>
        <li><span class="step-t">eigenvector ของ \(\lambda = 4\)</span> \(A - 4I_3\): แถว 2,3 ให้ \(x_2 = x_3\); แถว 1 ให้ \(-3x_1 - 2x_2 = 0 \Rightarrow x_1 = -\tfrac{2}{3}x_2\) → เลือก \(x_2 = -3\): \(\vec{v}_1 = (2, -3, -3)^T\)</li>
        <li><span class="step-t">eigenvector ของ \(\lambda = -2\)</span> \(A + 2I_3\): แถว 2 ให้ \(3x_2 + 3x_3 = 0 \Rightarrow x_2 = -x_3\); แถว 1 ให้ \(3x_1 - x_2 - x_3 = 0 \Rightarrow x_1 = 0\) → \(\vec{v}_2 = (0, 1, -1)^T\)</li>
        <li><span class="step-t">eigenvector ของ \(\lambda = 1\)</span> \(A - I_3 = \begin{bmatrix} 0 & -1 & -1\\ 0 & 0 & 3\\ 0 & 3 & 0 \end{bmatrix} \Rightarrow x_2 = 0, x_3 = 0, x_1\) เสรี → \(\vec{v}_3 = (1, 0, 0)^T\)</li>
        <li><span class="step-t">ผลเฉลยทั่วไป</span>
        ...
        <li><span class="step-t">ตรวจคำตอบ</span> \(A(2,-3,-3)^T = (2+3+3,\; -3-9,\; -9-3)^T = (8, -12, -12)^T = 4(2,-3,-3)^T\) ✓</li>
      </ol>
    </div></details>
  </article>
  ...
  <article class="pr-card" data-pkey="p3-3-4">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> ทฤษฎีบท 3.3.1 กำหนดว่า \(A\) ต้องแปลงเป็นทแยงมุมได้</p>
      <ol class="steps">
        <li><span class="step-t">ค่าลักษณะเฉพาะ</span> \(A\) สามเหลี่ยมบน → \(\det(A - \lambda I_2) = (1-\lambda)^2 = 0 \Rightarrow \lambda = 1\) ซ้ำ 2 ครั้ง</li>
        <li><span class="step-t">นับ \(E_1\)</span>
        \[ A - I_2 = \begin{bmatrix} 0 & 1\\ 0 & 0 \end{bmatrix} \;\Longrightarrow\; x_2 = 0 \;\Longrightarrow\; E_1 = \operatorname{Span}\{(1,0)^T\}, \; \dim = 1 \]</li>
        <li><span class="step-t">สรุป</span> ได้ eigenvector อิสระเพียง 1 ตัว &lt; 2 → \(A\) <strong>แปลงเป็นทแยงมุมไม่ได้</strong> → ทฤษฎีบท 3.3.1 ใช้กับระบบนี้ไม่ได้ (ผลเฉลยจริง ๆ มีพจน์ \(te^t\) ปนอยู่ ซึ่งอยู่นอกขอบเขตของสูตรนี้)</li>
      </ol>
    </div></details>
  </article>
  ...
  <article class="pr-card" data-pkey="p3-3-5">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> \(\lambda\) ซ้ำแต่เช็กว่า diagonalizable ก่อน แล้วทำตามสูตรปกติ</p>
      <ol class="steps">
        <li><span class="step-t">ค่าลักษณะเฉพาะ</span> สามเหลี่ยมบน → \(\lambda = 1, -2, 1\) (\(\lambda = 1\) ซ้ำ 2 ครั้ง)</li>
        <li><span class="step-t">เช็ก \(E_1\)</span>
        \[ A - I_3 = \begin{bmatrix} 0 & 0 & 0\\ 0 & -3 & 1\\ 0 & 0 & 0 \end{bmatrix} \;\Longrightarrow\; x_3 = 3x_2 \;\Longrightarrow\; E_1 = \operatorname{Span}\{(1,0,0)^T, (0,1,3)^T\}, \dim = 2 \checkmark \]</li>
        <li><span class="step-t">eigenvector ของ \(\lambda = -2\)</span>
        \[ A + 2I_3 = \begin{bmatrix} 3 & 0 & 0\\ 0 & 0 & 1\\ 0 & 0 & 3 \end{bmatrix} \;\Longrightarrow\; x_1 = 0, x_3 = 0 \;\Longrightarrow\; \vec{v} = (0, 1, 0)^T \]
        รวมได้ 3 เวกเตอร์อิสระ → diagonalizable → ใช้ทฤษฎีบท 3.3.1 ได้</li>
        <li><span class="step-t">ผลเฉลยทั่วไปและแทน \(t = 0\)</span>
        ...
        <li><span class="step-t">แก้หา \(C\)</span> \(C_1 = 2\); \(3C_2 = 15 \Rightarrow C_2 = 5\); \(5 + C_3 = 7 \Rightarrow C_3 = 2\)</li>
        <li><span class="step-t">ผลเฉลยเฉพาะ</span>
        \[ \vec{x}(t) = 2e^{t}\begin{bmatrix} 1\\ 0\\ 0 \end{bmatrix} + 5e^{t}\begin{bmatrix} 0\\ 1\\ 3 \end{bmatrix} + 2e^{-2t}\begin{bmatrix} 0\\ 1\\ 0 \end{bmatrix} \qquad \text{หรือ} \qquad \begin{aligned} x_1(t) &= 2e^t\\ x_2(t) &= 5e^t + 2e^{-2t}\\ x_3(t) &= 15e^t \end{aligned} \]</li>
        <li><span class="step-t">ตรวจคำตอบ</span> \(t = 0\): \((2, 7, 15)\) ✓ และสมการที่ 3 ที่ \(t = 0\): LHS \(x_3'(0) = 15\); RHS \(x_3(0) = 15\) ✓</li>
      </ol>
    </div></details>
  </article>
  ...
  <article class="pr-card" data-pkey="p3-3-6">
    ...
    <details class="sol"><summary>แนวคิดและเฉลยแบบละเอียด</summary><div class="sol-body">
      <p><strong>แนวคิด:</strong> อ่าน eigenpair จากรูปผลเฉลย แล้วสร้าง \(A\) ย้อนกลับด้วย \(A = PDP^{-1}\)</p>
      <ol class="steps">
        <li><span class="step-t">อ่าน eigenpair</span> พจน์ \(e^{2t}(1,1)^T\) บอกว่า \(\lambda_1 = 2, \vec{v}_1 = (1,1)^T\); พจน์ \(e^{-t}(1,-2)^T\) บอกว่า \(\lambda_2 = -1, \vec{v}_2 = (1,-2)^T\)</li>
        <li><span class="step-t">เขียน \(P, D\) และ \(P^{-1}\)</span>
        ...
        <li><span class="step-t">คำนวณ \(A = PDP^{-1}\)</span>
        ...
        <li><span class="step-t">ตรวจคำตอบ</span> \(A(1,1)^T = (2, 2)^T = 2(1,1)^T\) ✓ และ \(A(1,-2)^T = (1-2, 2+0)^T = (-1, 2)^T = -1\cdot(1,-2)^T\) ✓</li>
        <li><span class="step-t">ระบบที่สอดคล้อง</span>
        \[ \begin{aligned} x_1' &= x_1 + x_2\\ x_2' &= 2x_1 \phantom{+ x_2} \end{aligned} \]</li>
      </ol>
    </div></details>
  </article>
</section>
